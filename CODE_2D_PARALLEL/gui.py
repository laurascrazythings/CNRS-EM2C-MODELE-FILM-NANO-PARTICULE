...
class Application(tk.Tk):
    def __init__(self):
        ...
        frame_1 = InputForm_float(self, key = "Tsim", text_var = self.text_frame_1, default_value = self.default_value_1) #create a frame
        ...
        frame_2 = InputForm_float(self, key = "T_add", text_var = self.text_frame_2, default_value = self.default_value_2) #create a frame
        ...
        frame_3 = InputForm_float(self, key = "dt", text_var = self.text_frame_3, default_value = self.default_value_3) #create a frame
        ...
        frame_4 = InputForm_int(self, key = "Lx", text_var = self.text_frame_4, default_value = self.default_value_4) #create a frame
        ...
        frame_5 = InputForm_int(self, key = "Ly", text_var = self.text_frame_5, default_value = self.default_value_5) #create a frame
        ...
        frame_6 = InputForm_int(self, key = "Np", text_var = self.text_frame_6, default_value = self.default_value_6) #create a frame
        ...
        frame_7 = InputForm_int(self, key = "Np_dt", text_var = self.text_frame_7, default_value = self.default_value_7) #create a frame
        ...
        frame_8 = InputForm_float(self, key = "Hamaker", text_var = self.text_frame_8, default_value = self.default_value_8) #create a frame
        ...
        frame_9 = InputForm_float(self, key = "Rad_particle", text_var = self.text_frame_9, default_value = self.default_value_9) #create a frame
        ...
        frame_10 = InputForm_float(self, key = "Density_particle", text_var = self.text_frame_10, default_value = self.default_value_10) #create a frame
        ...
        frame_11 = InputForm_float(self, key = "Molar_mass_particle", text_var = self.text_frame_11, default_value = self.default_value_11) #create a frame
        ...
        frame_12 = InputForm_float(self, key = "Low_Particle_X_Velocity", text_var = self.text_frame_12, default_value = self.default_value_12) #create a frame
        ...
        frame_13 = InputForm_float(self, key = "High_Particle_X_Velocity", text_var = self.text_frame_13, default_value = self.default_value_13) #create a frame
        ...
        frame_14 = InputForm_float(self, key = "Low_Particle_Y_Velocity", text_var = self.text_frame_14, default_value = self.default_value_14) #create a frame
        ...
        frame_15 = InputForm_float(self, key = "High_Particle_Y_Velocity", text_var = self.text_frame_15, default_value = self.default_value_15) #create a frame
        ...
        frame_16 = InputForm_float(self, key = "Tau", text_var = self.text_frame_16, default_value = self.default_value_16) #create a frame
        ...
        frame_17 = InputForm_float(self, key = "B", text_var = self.text_frame_17, default_value = self.default_value_17) #create a frame
        ...
        frame_18 = InputForm_float(self, key = "Air_X_Velocity", text_var = self.text_frame_18, default_value = self.default_value_18) #create a frame
        ...
        frame_19 = InputForm_float(self, key = "Air_Y_Velocity", text_var = self.text_frame_19, default_value = self.default_value_19) #create a frame
        ...
        frame_20 = InputForm_bool(self, key = "Right_W", text_var = self.text_frame_20, default_value = self.default_value_20) #create a frame
        ...
        frame_21 = InputForm_bool(self, key = "Left_W", text_var = self.text_frame_21, default_value = self.default_value_21) #create a frame
        ...
        frame_22 = InputForm_bool(self, key = "Up_W", text_var = self.text_frame_22, default_value = self.default_value_22) #create a frame
        ...
        frame_23 = InputForm_bool(self, key = "Down_W", text_var = self.text_frame_23, default_value = self.default_value_23) #create a frame
        ...
        frame_24 = InputForm_bool(self, key = "Up_A", text_var = self.text_frame_24, default_value = self.default_value_24) #create a frame
...
class InputForm_float(ttk.Frame):
    def __init__(self, parent, key: str, text_var: tk.StringVar, default_value : tk.DoubleVar):
        ...
        self._initial_default = float(default_value.get())
...
class InputForm_int(ttk.Frame,):
    def __init__(self, parent, key: str, text_var: tk.StringVar, default_value : tk.IntVar):
        super().__init__(parent)
        self.key = key
        self.columnconfigure(0, weight = 1)
        self.rowconfigure(0, weight = 1)
...
class InputForm_bool(ttk.Frame):
    def __init__(self, parent, key: str, text_var: tk.StringVar, default_value : tk.BooleanVar):
        super().__init__(parent)
        self.key = key
        self.columnconfigure(0, weight = 1)
        self.rowconfigure(0, weight = 1)
    ...
    def get_value(self) -> bool:
        if self.text_list.size() > 0:
            return bool(self.text_list.get(0))
        return 
